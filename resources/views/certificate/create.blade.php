...
<div class="col-12 grid-margin createtable">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6 heading">
                             <a href="{{ route('certificate.index') }}" class="backicon"><i class="mdi mdi-backburger"></i></a>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div>
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('certificate.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
