                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6 col-sm-6 col-xs-12">
                            <h4 class="card-title">Date Wise Sales Report</h4>
                        </div>
                    </div>
                    @if ($errors->any())
                    ...
                    <!-- Search Form -->
                    <form action="{{ route('sales-report/date-wise') }}" method="GET">
    <div class="row">
        <!-- Customer Dropdown -->
        <div class="col-md-4">
        ...
        <div class="col-md-8 d-flex align-items-center">
            <div class="input-group">
                ...
                <a href="{{ route('sales-report/date-wise') }}" class="btn btn-secondary">Clear</a>
            </div>
        </div>
    </div>
</form>
